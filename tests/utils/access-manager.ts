...
function createOperationCanceledEvent(
  operationId: Bytes,
  nonce: BigInt
): OperationCanceled {
...
function createOperationExecutedEvent(
  operationId: Bytes,
  nonce: BigInt
): OperationExecuted {
...
function createOperationScheduledEvent(
  operationId: Bytes,
  nonce: BigInt,
  schedule: BigInt,
  caller: Address,
...
function createRoleGrantDelayChangedEvent(
  roleId: BigInt,
  delay: BigInt,
  since: BigInt
): RoleGrantDelayChanged {
...
function createRoleGrantedEvent(
  roleId: BigInt,
  account: Address,
  delay: BigInt,
  since: BigInt,
...
function createRoleGuardianChangedEvent(
  roleId: BigInt,
  guardian: BigInt
): RoleGuardianChanged {
  let roleGuardianChangedEvent = changetype<RoleGuardianChanged>(
    newMockEvent()
  );
...
function createRoleLabelEvent(roleId: BigInt, label: string): RoleLabel {
...
function createRoleRevokedEvent(roleId: BigInt, account: Address): RoleRevoked {
...
function createTargetAdminDelayUpdatedEvent(
  target: Address,
  delay: BigInt,
  since: BigInt
): TargetAdminDelayUpdated {
...
function createTargetClosedEvent(
  target: Address,
  closed: boolean
): TargetClosed {
...
function createTargetFunctionRoleUpdatedEvent(
  target: Address,
  selector: Bytes,
  roleId: BigInt
): TargetFunctionRoleUpdated {
